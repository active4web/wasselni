...
<input type="text" value="<?= $result->name?>"  placeholder="اسم المستخدم" class="form-control" name="name" required>
</div>
<div class="col-md-2"></div>
</div>
...
<input type="text" value="<?= $result->phone?>" placeholder="رقم التليفون" class="form-control" name="phone" required>
</div>
<div class="col-md-2"></div>
</div>
