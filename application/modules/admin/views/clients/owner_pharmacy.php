			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">مدير الصيدليات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">مدير الصيدليات</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/clients/delete_ownerpharmacy" method="POST" id="form">
                                        ...
                                        <?php
										 ...
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												$pharmacy_name=$agent_user=get_table_filed("team_work",array("id"=>$data->pharmacy_id),"name");
                                        	$type=$data->Validity;
                                         	switch($type){
													case 0:
													  $type="<span class='label label-sm label-danger'>التطبيق فقط</span>";
													  break;
													case 1:
													  $type="<span class='label label-sm label-success'>التطبيق والسيستم</span>";
													  break;
													  case 2:
													  $type="<span class='label label-sm label-success'>السيستم</span>";
													  break;
													default:
													  break; 
												}
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/clients/update_password_ownerpharamcy?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i>تعديل الباسورد</a></li>

															<li><a href="<?php echo base_url()?>admin/clients/update_ownerpharmacy?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/clients/delete_ownerpharmacy?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_ownerpharmacy");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/clients/check_view_ownerpharmacy") ?>',
                type: 'POST',
                data: data,				
