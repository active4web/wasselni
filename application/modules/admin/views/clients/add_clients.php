                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                <form action="<?=$url;?>admin/clients/client_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
                                                    <div class="form-body">
...
<input type="text" placeholder="اسم المستخدم" class="form-control" name="name" required>
</div>
<div class="col-md-2"></div>
</div>
