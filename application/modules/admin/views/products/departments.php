						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/products/delete_departments" method="POST" id="form">
									<div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												$image=$data->img;
												$base=base_url();
												$img=$base."uploads/departments/".$image; 
													$total_country=$this->db->get_where("services_countries",array("cat_id"=>$data->id,'type'=>'1'))->result();
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                               ...
                                               <td><a href="<?= base_url()?>admin/products/departments_countries?tab_id=<?=$data->id;?>"> الدول (<?=count($total_country);?> )</a>  </td>

												<td> <?=$data->name;?> </td>
												<td> <?=$data->name_en;?> </td>
												<td> <?=$data->name_tr;?> </td>
												<td> <?=$data->arrange_type;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/products/details_departments?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?= base_url()?>admin/products/delete_departments?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/products/check_view_departments") ?>',
                type: 'POST',
                data: data,				
