								...
								<span class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										$country_name=get_table_filed('countries',array('id'=>$data->country_id),"name");		
											$category_name=get_table_filed('category',array('id'=>$data->cat_id),"name");
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/products/details_country?type=0&tab_id=<?= $this->input->get("tab_id");?>&id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?= base_url()?>admin/products/delete_country?type=0&tab_id=<?= $this->input->get("tab_id");?>&id=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/products/add_country?type=0&tab_id=<?= $this->input->get("tab_id");?>");
    });
