                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <?php foreach($department_data as $result)?>
                                <form  class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data" id="form"  action="<?= base_url()?>admin/products/edit_departments_action">
...
<select name="id_cat" class="form-control ltr">
...
<input type="text" id="title" value="<?= $result->name?>" placeholder="عنوان القسم الفرعى" class="form-control" name="title" >
</div>

<div class="col-md-4">
<span class="help-block ltr">Title Of Department</span>
<input type="text" value="<?= $result->name_en?>" id="title_en" placeholder="Title Of Department" class="form-control ltr" name="title_en" >
</div>

<div class="col-md-4">

<span class="help-block ltr">Başlık	</span>
<input type="text" id="title_tr" value="<?= $result->name_tr?>"  placeholder="Başlık" class="form-control ltr" name="title_tr" >
		...
		<div class="col-md-3" style="text-align:center"></div>
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
							    <img src="<?= base_url()?>uploads/departments/<?= $result->img?>">
							</div>
