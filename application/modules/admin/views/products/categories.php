						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/products/delete_category" method="POST" id="form">
									<div>
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												switch($view){
													...
													$image=$data->img;
												$base=base_url();
												$img=$base."uploads/categories/".$image; 
												
													$total_country=$this->db->get_where("services_countries",array("cat_id"=>$data->id,'type'=>'0'))->result();
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                               ...
                                               <td><a href="<?= base_url()?>admin/products/services_countries?tab_id=<?=$data->id;?>"> الدول (<?=count($total_country);?> )</a>  </td>
												<td> <?=$data->name;?> </td>
													<td> <?=$data->name_en;?> </td>
													<td> <?=$data->name_tr;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/products/details_category?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?= base_url()?>admin/products/delete_category?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/products/add_category");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/products/check_view_catageries") ?>',
                type: 'POST',
                data: data,				
