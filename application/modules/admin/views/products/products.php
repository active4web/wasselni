			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الخدمات القانونية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الخدمات القانونية</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/products/delete_product" method="POST" id="form">
                                        ...
                                        <?php
										 ...
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												$image=$data->img;
												$base=base_url();
												$img=$base."uploads/products/".$image; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/products/update_product?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/products/delete_product?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/products/check_view_product") ?>',
                type: 'POST',
                data: data,				
