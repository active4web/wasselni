...
<li>
						...
						<li>
							<span class="active">الموصى بيه</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/products/delete_recommended" method="POST" id="form">
									<div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												$name_cat=get_table_filed("team_work",array("id"=>$service_id),"name");
												$image=$data->img;
												$base=base_url();
												$img=$base."uploads/recommended/".$image; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/products/details_recommended?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
														</ul>
													</div>
												</td>
											</tr>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/products/add_recommended");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/products/check_view_recommended") ?>',
                type: 'POST',
                data: data,				
