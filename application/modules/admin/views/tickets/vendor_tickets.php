									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$data->title;?> </td>
												<td> <?php echo get_this('clients',['id'=>$data->created_by],'name');?> </td>
												<td> <?=$data->created_at;?> </td>
												<td><a href="<?=$url?>admin/tickets/edit?type=2&id=<?=$data->id;?>"> <?=count($reply_counts);?></a> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?=$url?>admin/tickets/edit?type=2&id_ticket=<?=$data->id;?>"><i class="fa fa-eye"></i> تفاصيل </a></li>
															<li><a href="<?php echo base_url()?>admin/tickets/delete_tickets?type=2&id_ticket=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
