									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td><a href="<?=$url?>admin/tickets/edit?type=1&id=<?=$data->id;?>"> <?=count($reply_counts);?></a> </td>
													<td> 
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?=$url?>admin/tickets/edit?type=1&id=<?=$data->id;?>"><i class="fa fa-eye"></i> تفاصيل </a></li>
															<li><a href="<?php echo base_url()?>admin/tickets/delete_tickets?type=1&id_ticket=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
