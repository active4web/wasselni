			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"> (  <?= get_table_filed("team_work",array("id"=>$this->input->get('id')),"name");?>)</span>
						</li>
						<li>
							<span class="active">الأدوية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الأدوية</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/teamwork/delete_pharmaceutical" method="POST" id="form">
									    <input type="hidden" name="id_pharmacy" value="<?= $this->input->get("id");?>">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('pharmaceutical',array('id_pharmacy'=>$this->input->get('id')))->result();
										 if(count($tt)>0){
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/teamwork/update_pharmaceutical?id_pharmacy=<?= $this->input->get('id');?>&id=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/teamwork/delete_pharmaceutical?id_pharmacy=<?= $this->input->get('id');?>&id=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_pharmaceutical?id="+<?= $this->input->get("id")?>);
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/teamwork/check_view_pharmaceutical") ?>',
                type: 'POST',
                data: data,				
