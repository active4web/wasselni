...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
		...
		<div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
                        <a href="<?=$url.'admin/regulation_service';?>">خدمة إعتماد لوائح تنظيم العمل</a>
                        <i class="fa fa-circle"></i>
						</li>
                        <li>
    ...
    <form action="<?=$url;?>admin/regulations/regulation_service_edit_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
