...
<input type="text" id="name" placeholder="الاسم" class="form-control" name="name" required>
</div>

<div class="col-md-4">
<span class="help-block">رقم التليفون </span>
<input type="text" id="phone" placeholder="رقم التليفون" class="form-control" name="phone" required>
</div>

<div class="col-md-4">
<span class="help-block">البريد الألكترونى</span>
<input type="email" id="email" placeholder="البريد الألكترونى" class="form-control" name="email" required>
</div>
</div>
