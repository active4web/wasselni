			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">المندوبين</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/agents/delete_agent" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
                                            ...
                                            foreach($results as $data) {
												...
												$total_services=$this->db->get_where("team_work",array('id_admin'=>$data->id))->result();
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/agents/update_password?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i>تعديل الباسورد</a></li>

															<li><a href="<?php echo base_url()?>admin/agents/update_agent?id=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>admin/agents/delete_agent?id=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_agent");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/agents/check_view_agent") ?>',
                type: 'POST',
                data: data,				
