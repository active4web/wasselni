			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">مقدمة الصفحة الرئيسية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
													...
													<div class="portlet light bordered form-fit">
														...
														<?php
															foreach($site_info as $result){
																$about_site = $result->breif_txt_eng;
																$about_site_ar = $result->breif_txt_ar;
																$about_img = $result->breif_img;
															}
														?>
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
																			...
																			<div>
																				<span class="btn default btn-file">
																					<span class="fileinput-new">البنر <?=get_img_size("home_intro");?></span>
