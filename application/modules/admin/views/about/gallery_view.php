...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
		...
		<div class="page-container">
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/about/delete_gallery" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('gallery_using')->result();
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												$image=$data->img;
												$base=base_url();
												$img=$base."uploads/gallery/".$image; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
			...
			<td><a title="view image" class="example-image-link" href="<?php echo $img;?>" data-lightbox="example-1">مشاهدة الصورة</a></td>
							...
							<li><a href="<?php echo base_url()?>admin/about/delete_gallery?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i>حذف </a></li>
							<li><a href="<?php echo base_url()?>admin/about/update_gallery?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i>تعديل</a></li>
														</ul>
													</div>
												</td>
											</tr>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_gallery");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/about/check_view_gallery") ?>',
                type: 'POST',
                data: data,				
