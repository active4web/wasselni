			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"> كيفية الاشتراك</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="profile-content">
								<div class="row">
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i> كيفية الاشتراك</div>
									...
									$about_site = $result->subscribe;
									$about_site_ar = $result->subscribe_ar;
															
															}
														?>
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $url?>admin/about/edit_subscribe" class="form-horizontal form-bordered"
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> المحتوي </span>
																			<textarea id="about_site_ar" name="subscribe_ar" id="about_site_ar"><?=$about_site_ar;?></textarea>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> Context </span>
																			<textarea id="about_site" name="subscribe" id="about_site"><?=$about_site;?></textarea>
																			<!-- <?php //echo $this->ckeditor->editor("description","description");?> -->
