			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">القائمة البريدية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold red cancel">مراسلة الكل 
									...
									<form action="<?=$url;?>admin/messages/replay_all" method="POST" id="form">
                                    ...
                                    <th> </th>
										...
										<tbody>
                     <?php
										 $tt=$this->db->get_where('news_letter')->result();
										 if(count($tt)>0){
                                        ...
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input type="checkbox" class="checkboxes" value="<?=$data->email;?>" name="check[]" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->email;?> </td>
                                    ...
                                    <td>
                                    <a href="<?php echo base_url()?>admin/messages/replay?email=<?= $data->email;?>"><i class="fa fa-reply"></i> ارسال </a>
                                    </td>
										<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/news_letter/delete?id=<?= $data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
                                             <li><a href="<?php echo base_url()?>admin/messages/reply?email=<?= $data->email;?>"><i class="fa fa-reply"></i> ارسال </a></li>
...
$(document).ready(function(e) {
	...
	$(".cancel").click(function(){
		if($('input[type=checkbox]:not("#checkAll"):checked').length>0){
			...
			toastr.warning("من فضلك حدد على الاقل ايميل");
	}
	});
});
</script>
