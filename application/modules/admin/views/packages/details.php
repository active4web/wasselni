		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<input name="id"  value="<?=$services_type->id;?>" type="hidden" class="form-control">
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-10">
																		<span class="help-block">المحافظة</span>
																			<input name="title" id="title" value="<?=$services_type->name;?>" type="text" placeholder="المحافظة" class="form-control" required>
