						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/packages/delete_package" method="POST" id="form">
									<div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=$data->name_package;?> </td>
												<td> <?=$data->name_packege_eng;?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/packages/details_package?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/packages/delete_package?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/packages/add_package");
    });
...
//alert(id);
			$.ajax({
				url: '<?php echo base_url("admin/packages/check_view_package") ?>',
                type: 'POST',
                data: data,				
