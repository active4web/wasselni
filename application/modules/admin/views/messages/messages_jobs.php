...
<title>طلب الاشتراك فى الصيدليات</title>
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<div class="row">
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
		                            ...
		                            <i class="icon-settings font-dark"></i>
										<span class="caption-subject bold uppercase">طلب الأشتراك فى الصيدليات</span>
									</div>
								</div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										<thead>
											<tr>
												...
												<th class="center">صاحب الصيدلية</th>
												<th class="center">التليفون</th>
												<th class="center" >واتس اب</th>
												<th class="center" >الصيدلية</th>
										    	<th class="center" >العنوان</th>
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td><?= mb_substr($name,0,50);?></td>
												<td><?=$data->phone;?></td>
                                                <td><?= $data->whats;?></td>
                                                 <td><?= $data->pharamcy_name;?></td>
                                                  <td><?= $data->state."".$data->city."".$data->place;?></td>
                                                  	<td>
						...
						<li> <a href="<?= base_url()?>admin/messages/view_jobmessage?id=<?= $data->id;?>"><i class="fa fa-eye"></i> التفاصيل</a></li>
...
$(document).ready(function(e) {
	...
	$(".cancel").click(function(){
		if($('input[type=checkbox]:not("#checkAll"):checked').length>0){
			...
			toastr.warning("من فضلك حدد مجموعة للحذف");
	}
	});
});
</script>
