                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
               <form action="<?=$url;?>admin/messages/replay_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
                <input type="hidden" value="<?= $this->input->get("type");?>" name="type">
                        ...
                        <input type="text"  placeholder="البريد الألكترونى" class="form-control" name="email" value="<?php echo $email?>" readonly>
