							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الصادر
								...
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/emails/deleteexport_emial" method="POST" id="form">
...
?>
											<tr class="odd gradeX">
												...
												<td><a href="<?=$url?>admin/emails/view_export_email?id=<?=$data->id;?>"> <?=mb_substr($content,0,20);?></a> </td>
												<td> <?=$creation_date;?> </td>
												<td>
