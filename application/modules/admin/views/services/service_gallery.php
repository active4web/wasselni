						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/services/delete_slider" method="POST" id="form">
									    <input type="hidden" name="id_section" value="<?= $this->input->get("id");?>">
									<div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
											...
											$image=$data->img;
												$base=base_url();
												$img=$base."uploads/service/slider/".$image; 
                                        $name=get_table_filed("state",array("id"=>$data->service_id),"name");
                                        $phone=get_table_filed("state",array("id"=>$data->service_id),"phone");
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?= base_url()?>admin/services/delete_slider?id_section=<?= $this->input->get("id");?>&id=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/services/add_gallery?id_tab=<?= $this->input->get("id");?>");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/services/check_view_slider") ?>',
                type: 'POST',
                data: data,				
