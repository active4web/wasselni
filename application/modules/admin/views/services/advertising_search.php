...
<ul class="ss"></ul>
								...
								<span class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        $total_branches=$this->db->get_where("tags",array("service_id"=>$data->id))->result();
											...
											<tr class="odd gradeX">
												...
												<td>
													<div class="btn-group">
														...
														<li><a href="<?= base_url()?>admin/services/service_tags?id=<?=$data->id;?>"><i class="fa fa-align-justify"></i>(<?= count($total_branches)?>) التاج</a></li>
