...
<li>
						...
						<li>	<a href="<?=$url.'admin/services/home';?>">
							...
							<li>
							    	<a href="<?=$url?>admin/services/service_gallery?id=<?= $this->input->get("id_tab")?>">
							    	    معرض الصور
                                               </a>
								<i class="fa fa-circle"></i>
						</li>
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet ">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                 <form action="<?=$url;?>admin/services/slider_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
