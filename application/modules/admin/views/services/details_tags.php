                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet ">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                 <form action="<?=$url;?>admin/services/edit_tags_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
...
<input type="text" value="<?= $res->name?>" placeholder="التاج" class="form-control " name="title">
</div>

<div class="col-md-6">
<span class="help-block" style="float:left">Tag</span>
<input type="text" value="<?= $res->name_en?>" placeholder="Tag" class="form-control ltr" name="title_en">
</div>
