...
<head>
<meta charset="utf-8">
<title>الصورة الرئيسية للانجازات </title>
			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"> الصورة الرئيسية للانجازات </span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i> الصورة الرئيسية للانجازات </div>
													...
													<div class="portlet light bordered form-fit">
														...
														<?php
															foreach($site_info as $result){
																$about_img = $result->main_img;
															}
														?>
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $url?>admin/faq/edit_img" class="form-horizontal form-bordered"
