                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet ">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                 <form action="<?=$url;?>admin/services/product_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
...
<input type="text" placeholder="اسم المنتج" class="form-control " name="title">
</div>
...
<div class="col-md-3">
<span class="help-block" style="float:left">Ürün başlığı</span>
<span class="caption-subject font-red bold uppercase">
<input type="text" placeholder="Ürün başlığı" class="form-control ltr" name="title_tr">
</div>

<div class="col-md-3">
<span class="help-block" style="float:left">Current Price</span>
<span class="caption-subject font-red bold uppercase">
<input type="text" placeholder="Current Price" class="form-control ltr" name="current_price">
</div>

<!--<div class="col-md-3">-->
<!--<span class="help-block" style="float:left">Old Price</span>-->
<!--<span class="caption-subject font-red bold uppercase">-->
<!--<input type="text" placeholder="Old Price" class="form-control ltr" name="old_price">-->
<!--</div>-->
...
<span class="caption-subject font-red bold uppercase">
<textarea name="description_ar" style="width:100%;height:60px" class="form-control"  placeholder="وصف المنتج"></textarea>
</div>
...
<span class="caption-subject font-red bold uppercase">
<textarea name="description_en" style="width:100%;height:60px" class="form-control ltr" laceholder="Description Product"></textarea>
</div>
...
<span class="caption-subject font-red bold uppercase">
<textarea name="description_tr" style="width:100%;height:60px" class="form-control ltr" laceholder="Ürün Tanımı "></textarea>
</div>
