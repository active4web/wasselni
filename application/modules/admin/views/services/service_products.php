						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/services/delete_product_service" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
											...
											$image=$data->img;
												$base=base_url();
												$img=$base."uploads/service/products/".$image; 
                                        ...
                                        ?>
											...
											<tr class="odd gradeX">
												...
												<td> <?= mb_substr($data->name_tr,0,40);?> </td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/services/details_product?id_tab=<?= $this->input->get("id")?>&id=<?=$data->id;?>"><i class="fa fa-eye"></i> التفاصيل </a></li>
															<li><a href="<?= base_url()?>admin/services/delete_product_service?id_tab=<?= $this->input->get("id")?>&id=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/services/add_products?id_tab=<?= $this->input->get("id")?>");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/services/check_view_product") ?>',
                type: 'POST',
                data: data,				
