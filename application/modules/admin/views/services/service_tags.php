				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
                        <li>
						 ...
						 <li>
							<a href="<?=$url.'admin/services/home'?>">مقدمى الخدمة</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span class="active">التاج</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/services/delete_tags" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        $service_name=get_table_filed("team_work",array("id"=>$data->service_id),"name");
                                        ?>
											...
											<tr class="odd gradeX">
												...
												<td> <?= mb_substr($data->name_en,0,40);?> </td>
												<td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/services/details_tags?id_tab=<?= $this->input->get("id")?>&id=<?=$data->id;?>"><i class="fa fa-eye"></i> التفاصيل </a></li>
															<li><a href="<?= base_url()?>admin/services/delete_tags?id_tab=<?= $this->input->get("id")?>&id=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
									...
									<?php }else{?>
									<center><span class="caption-subject font-red bold uppercase">عفوا لاتوجد بيانات </span></center>
									<?php }?>
								<div class="row">
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/services/add_tags?id_tab=<?= $this->input->get("id")?>");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/services/check_view_tags") ?>',
                type: 'POST',
                data: data,				
