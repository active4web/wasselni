...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
   ...
   <div class="form-group">
									...
									<div class="col-md-3">
                                       ...
                                       <input type="text"   placeholder="New Price" class="form-control ltr" name="new_price">
									</div>
															
									<div class="col-md-3">
                                       <span class="help-block ltr" >Start Date </span>
                                       <input type="date"  placeholder="Start Date" class="form-control ltr" name="start_date">
									</div>
															
															
									<div class="col-md-3">
                                        <span class="help-block ltr" >End Date</span>
      ...
      <div class="form-group">									
                                    <div class="col-md-4">
                                           ...
                                           <input type="text"   placeholder="عنوان العرض" class="form-control" name="title">
									</div>
                                                        
                                   <div class="col-md-4">
                                            <span class="help-block ltr" >Offer Title</span>
                                            <input type="text"   placeholder="Offer Title" class="form-control ltr" name="title_en">
									</div>
                                  <div class="col-md-4">
                                            <span class="help-block ltr" >Teklif Başlığı </span>
                                            <input type="text"   placeholder="Teklif Başlığı" class="form-control ltr" name="title_tr">
									</div>
                                   
    </div>                           
 <div class="form-group">
                                    <div class="col-md-6">
                                           <span class="help-block">مقدم الخدمة 
                                           </span> 
                                           <!--<select name="service_id"  class="form-control">
                                               <option value="">من فضلك حدد مقدم العرض</option>
                                               <?php
                                               foreach($team_work as $teamwork){
                                               ?>
                                                <option value="<?= $teamwork->id?>"><?= $teamwork->name?></option>
                                               <?php }?>
                                           </select>-->
   ...
   <input type="text"   placeholder="الترتيب" class="form-control" name="arrange_type">
								...
								<div class="form-group">
                             	...
                             	<div class="form-group">
												...
												<textarea  name="description_en" class="form-control ltr"  style="width:100%;height:120px;"></textarea>
												</div>
								</div>
									<div class="form-group">
												<div class="col-md-12" style="text-align:center">
												<span class="help-block" style="padding:20px;">İçerik </span>
												<textarea  name="description_tr" class="form-control ltr"  style="width:100%;height:120px;"></textarea>
												</div>
							     	</div>				
