						...
						<div class="col-md-12">
							...
							<div class="portlet">
								...
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/offers/delete_offers" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td><?= mb_substr($data->offer_name,0,20);?></td>
												<td><?= mb_substr($data->offer_name_en,0,20);?></td>
												<td><?= mb_substr($data->name_tr,0,20);?></td>
												<td><?= mb_substr($data->arrange_type,0,30);?></td>
												<td><?= $data->phone;?></td>
												<td><?= mb_substr($service_name,0,40)?></td>
