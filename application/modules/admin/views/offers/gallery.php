						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<input type="hidden" name="id_tab" value="<?= $id_tab?>">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('gallery',array('type'=>'2','id_tab'=>$id_tab))->result();
										 if(count($tt)>0){
                                            foreach($results as $data) {
												...
												$image=$data->image;
												$base=base_url();
												$img=$base."uploads/gallery/offers/".$image; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
								...
								<li><a href="<?php echo base_url()?>admin/offers/delete_gallery?id_type=<?php echo $data->id;?>&id_tab=<?= $id_tab?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
									...
									<br>
                                        ...
                                        <ul class="nav nav-pills">
                                            ...
                                            <a href="javascript:;"> <?=lang('total_records');?>
                                                <span class="badge badge-success pull-right"> <?php echo count($tt); ?> </span>
                                            </a>
                                            </li>
                                        </ul>
                                        </div>
