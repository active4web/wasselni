						...
						<div class="col-md-12">
							...
							<div class="portlet ">
								...
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/places/delete_country" method="POST" id="form">
									<div>
												...
												switch($view){
													...
													default:
													  break; 
												    	...
												    	$qr_img=$data->icon;
												$base=base_url();
												$flags=$base."uploads/flags/".$qr_img; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
								...
								<td><a title="view image" class="example-image-link" href="<?php echo $flags;?>" data-lightbox="example-1"><?=lang('view');?></a></td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/places/details_country?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?= base_url()?>admin/places/delete_country?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/add_country");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/delete_country");
	});
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/places/check_view_country") ?>',
                type: 'POST',
                data: data,				
