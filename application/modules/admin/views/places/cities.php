...
<li>
						...
						<li>
							<span class="active">المناطق</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
 ...
 $state_name=get_table_filed('state',array('id'=>$data->state_id),"name");
  $id_country=get_table_filed('state',array('id'=>$data->state_id),"id_country");
