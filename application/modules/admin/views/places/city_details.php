					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="profile-content">
								...
								<form action="<?php echo $url?>admin/places/edit_city_action" class="form-horizontal form-bordered" method="post" >
															    
																<div class="form-body">
																<?php  foreach($services_type as $services_type)
																
																$state_name=get_table_filed('state',array('id'=>$services_type->state_id),"name");
																$id_country=get_table_filed('state',array('id'=>$services_type->state_id),"id_country");
																$country_name=get_table_filed('countries',array('id'=>$id_country),"name");
																?>	
																<input type="hidden" value="<?= $services_type->id;?>"  name="id">
																
																
																<div class="form-group">
																		<div class="col-md-6">
																		<span class="help-block">من فضلك حدد الدولة (<?= $country_name?></span>
																		<select name="category_id" class="form-control" id="category"  onchange="getsubcat(this.value)" >
																	...
																	<div class="col-md-6">
																		<span class="help-block">من فضلك حدد المحافظة (<?= $state_name?></span>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">الأسم</span>
																			<input name="title" value="<?= $services_type->name;?>"  id="title"  type="text" placeholder="الأسم" class="form-control" required>
																		</div>
																			<div class="col-md-3">
																		<span class="help-block ltr">Title</span>
																			<input name="title_en"  value="<?= $services_type->name_en;?>" id="title_en"  type="text" placeholder="Title" class="form-control ltr" required>
