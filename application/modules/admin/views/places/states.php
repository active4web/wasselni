...
<li>
						...
						<li>
							<span class="active">المحافظات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">المحافظات</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?= base_url()?>admin/places/delete_state" method="POST" id="form">
									<div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?= base_url()?>admin/places/details_state?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?= base_url()?>admin/places/delete_state?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/add_state");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/places/check_view_state") ?>',
                type: 'POST',
                data: data,				
