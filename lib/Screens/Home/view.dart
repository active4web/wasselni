                ...
                child: ClipRRect(
                  ...
                  child: Swiper(
                    ...
                    itemBuilder: (context, index) => InkWell(
                      onTap: sliderImageInMain[index].link!.isEmpty ||
                              sliderImageInMain[index].link == null ||
                              sliderImageInMain[index].link == ''
                          ? () {}
                          : () async {
                              await launchUrl(Uri.parse(
                                  'http:${sliderImageInMain[index].link}'));
                            },
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        width: width * 0.4,
                        child: CachedNetworkImage(
                          placeholder: (context, url) => Image.asset(appLogo),
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(
                        horizontal: width * 0.015, vertical: hight * 0.01),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Container(
